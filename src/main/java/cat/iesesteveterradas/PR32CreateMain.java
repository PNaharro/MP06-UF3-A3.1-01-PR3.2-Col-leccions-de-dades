...
public class PR32CreateMain {
    ...
    public static void main(String[] args) {
        try {
            ...
            String uri = "mongodb://elTeuUsuari:laTeuaContrasenya@localhost:27017/?authSource=admin";
            try (MongoClient mongoClient = MongoClients.create(uri)) {
                ...
                // Procesar solo las 20 primeras líneas
                int count = 0;
                for (int i = 0; i < nodeList.getLength() && count < 20; i++) {
